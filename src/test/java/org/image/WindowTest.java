...
public class WindowTest {
    ...
    public void testDecodeBase64ToImage_invalidBase64String() {
        ...
        assertThrows(IllegalArgumentException.class, () -> Tools.decodeBase64ToImage(invalidBase64ImageString),
    ...
    public void testDecodeBase64ToImage_nullBase64String() {
        ...
        assertThrows(NullPointerException.class, () -> Tools.decodeBase64ToImage(nullBase64ImageString),
    ...
    public void testDisplayImages() {
        ...
        BufferedImage testImage = Tools.decodeBase64ToImage(validBase64ImageString);
