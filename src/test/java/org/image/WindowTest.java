...
public class WindowTest {
    ...
    public void testDecodeBase64ToImage_invalidBase64String() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ImageProcessor.decodeBase64ToImage(invalidBase64ImageString),
    ...
    public void testDecodeBase64ToImage_nullBase64String() {
        ...
        assertThrows(NullPointerException.class, () -> ImageProcessor.decodeBase64ToImage(nullBase64ImageString),
    ...
    public void testDisplayImages() {
        ...
        BufferedImage testImage = ImageProcessor.decodeBase64ToImage(validBase64ImageString);
