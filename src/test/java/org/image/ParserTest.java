...
public class ParserTest {
    ...
    public void testParseInvalidUrl() {
        ...
        assertThrows(IllegalArgumentException.class, () -> LinkParser.parseUrl(invalidUrl),
    ...
    public void testParseUrlNoLinks() {
        ...
        assertEquals(0, LinkParser.getNumberOfFoundLinks(), "parseUrl should not find any magnet links");
    }
    ...
    public void testParseUrlMultipleLinks() {
        ...
        LinkParser.parseUrl(url);
        assertEquals(expectedNumberOfLinks, LinkParser.getNumberOfFoundLinks(), "parseUrl should find all magnet links");
    }
    ...
    public void testOpenMagnetLinkInTorrentClient() {
        ...
        LinkParser.openMagnetLinkInTorrentClient(magnetLink, Desktop.getDesktop());
